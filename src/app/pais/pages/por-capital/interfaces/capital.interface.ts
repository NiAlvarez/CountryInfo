...
//
//   const rESTCapitalResponse = Convert.toRESTCapitalResponse(json);
//
...
export class Convert {
    public static toRESTCapitalResponse(json: string): Capital[] {
        return cast(JSON.parse(json), a(r("RESTCapitalResponse")));
    }

    public static rESTCapitalResponseToJson(value: Capital[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCapitalResponse"))), null, 2);
    }
}
